            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-screen-2xl mx-auto">
                ...
                <div className="p-4">
                    ...
                    <p className="text-[1rem] font-normal">
                        Say Hello to India’s top doctors via video consultation, get digital prescriptions, order medicines, book doctor appointments & lab tests, find doctors near you, get health packages, ask a free health question to doctors                    </p>
                </div>
            </div>

            <div className="text-center text-sm font-semibold mt-7 pt-4 mb-2.5">
                Made with 💓 by brainstromers, Copyright © 2024 All rights reserved by Meet, Kashish and Ramesh
            </div>
        </footer>
    );
};
